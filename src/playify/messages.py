...
MESSAGES: dict[str, str] = {
    ...
    "bootstrap.run_managed": "Run Playify through start.bat or start.sh so it uses .venv.",
    ...
    "bootstrap.stage_failed": "The staged environment failed validation; the active environment is unchanged.",
    ...
    "bootstrap.venv_unavailable": "The managed .venv is unavailable after setup.",
    ...
    "tui.main.venv_required": "[error]The TUI must run with Playify's exact .venv interpreter.[/]",
    ...
    "tui.maintenance.menu": "[1] Stage dependencies/interpreter  [2] Install/update managed FFmpeg  [3] Run all  [Esc] Back",
    "tui.maintenance.choice": "Choice",
    "tui.maintenance.staged": "[success]A validated environment is staged for the next launcher start.[/]",
    "tui.maintenance.stage_failed": "[error]Environment staging failed; the active environment is unchanged: {error}[/]",
