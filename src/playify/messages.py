...
MESSAGES: dict[str, str] = {
    ...
    "tui.dashboard.restart_badge": "[yellow]{scope} restart required[/]",
    "tui.dashboard.header": "[bold cyan]Playify {version}[/]{separator}{status}{badge}",
    "tui.dashboard.hotkeys": "[bold]L[/] Logs  [bold]C[/] Config  [bold]S[/] Settings  [bold]U[/] Update  [bold]M[/] Maintenance  [bold]R[/] Restart  [bold]Q[/] Quit",
